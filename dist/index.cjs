...
function requireTypes$1 () {
	...
	types$1.isSyncTransform = isSyncTransform;
...
function requireRowFormatter () {
	...
	let RowFormatter$1 = class RowFormatter {
...
function requireSrc$2 () {
	...
	(function (exports) {
		...
		const writeToPath = (path, rows, options) => {
		    const stream = fs$1.createWriteStream(path, { encoding: 'utf8' });
...
function requireSrc$1 () {
	...
	(function (exports) {
		...
		const parseFile = (location, options = {}) => {
		    return fs$1.createReadStream(location).pipe(new CsvParserStream_1.CsvParserStream(new ParserOptions_1.ParserOptions(options)));
		};
...
FileUtils.readCSV = (filePath) => new Promise((resolve, reject) => {
    ...
    fs.createReadStream(filePath)
        .pipe(srcExports.parse({ headers: true }))
        .on("data", (row) => {
        allData.push(row);
    })
        .on("end", () => {
...
FileUtils.writeCSV = (filePath_1, data_1, ...args_1) => __awaiter(void 0, [filePath_1, data_1, ...args_1], void 0, function* (filePath, data, includeHeader = true) {
    ...
    return new Promise((resolve, reject) => {
        srcExports.write(data, { headers: includeHeader })
            .pipe(writeStream)
            .on("finish", resolve)
            .on("error", reject);
    });
...
_a = CacheCursor;
CacheCursor.getSavedCacheCursorPath = (userId) => {
    const baseDir = path.resolve("cache_cursor", userId);
    return {
        POSTS_ID_CACHE_CURSOR_PATH: path.resolve(baseDir, "posts_id.json"),
    };
};
CacheCursor.writeCacheCursor = (userId, type, cursor) => {
    const { POSTS_ID_CACHE_CURSOR_PATH } = _a.getSavedCacheCursorPath(userId);
    const mappedPath = {
        POSTS_ID: POSTS_ID_CACHE_CURSOR_PATH,
    };
    FileUtils.writeToFile(mappedPath[type], JSON.stringify(cursor, null, 2));
};
CacheCursor.getCacheCursor = (userId, type) => {
    const { POSTS_ID_CACHE_CURSOR_PATH } = _a.getSavedCacheCursorPath(userId);
    const mappedPath = {
        POSTS_ID: POSTS_ID_CACHE_CURSOR_PATH,
    };
    return FileUtils.readObjectFromJsonFile(mappedPath[type]);
};

class PathUtils {
}
PathUtils.getLocalDownloadDir = () => {
    const LOCAL_DOWNLOAD_DIR = path.resolve(process.env.USERPROFILE || "", "Downloads");
...
PathUtils.getSavedProfileStatisticsDirPath = (userId) => {
    ...
    const BASE_DIR = path.resolve(LOCAL_DOWNLOAD_DIR, "facebook_statistics", userId);
    return {
...
class FacebookRequest {
    constructor(cookies) {
        this.getCurrentUserToken = () => __awaiter(this, void 0, void 0, function* () {
            try {
                const { data } = yield this.axiosInstance.get("https://www.facebook.com/");
                const userId = data.match(/"userId":(\d+)/)[1];
                const fbDtsg = data.match(/"DTSGInitialData".*?"token":"(.*?)"/)[1];
                return { userId, fbDtsg };
            }
            catch (error) {
                throw new Error("❌ Error when getting your Facebook token: Invalid cookie");
            }
        });
        this.makeRequestToFacebook = (userToken, docID, query) => __awaiter(this, void 0, void 0, function* () {
            ...
            const { data } = yield this.axiosInstance.post("/", formData);
            return data;
        });
        this.getAllLikedPages = (...args_1) => __awaiter(this, [...args_1], void 0, function* (writeToCSV = false) {
            var _a, _b, _c, _d, _e, _f;
            const userToken = yield this.getCurrentUserToken();
            const allLikedPages = [];
            ...
            do {
                ...
                const query = Object.assign(Object.assign({}, baseQuery), (allLikedPages.length && { count: 20, cursor: endCursor }));
                const responseData = yield this.makeRequestToFacebook(userToken, docID, query);
                const originalLikedPagesList = (_c = (_b = (_a = responseData === null || responseData === void 0 ? void 0 : responseData.data) === null || _a === void 0 ? void 0 : _a.node) === null || _b === void 0 ? void 0 : _b.sorted_liked_and_followed_pages) === null || _c === void 0 ? void 0 : _c.edges;
                const pageInfor = (_f = (_e = (_d = responseData === null || responseData === void 0 ? void 0 : responseData.data) === null || _d === void 0 ? void 0 : _d.node) === null || _e === void 0 ? void 0 : _e.sorted_liked_and_followed_pages) === null || _f === void 0 ? void 0 : _f.page_info;
            ...
            console.log(`✅ Get all liked pages successfully. Total: ${allLikedPages.length}`);
            if (writeToCSV && allLikedPages.length) {
                const { LIKED_PAGES } = PathUtils.getSavedProfileStatisticsDirPath(userToken.userId);
                yield FileUtils.writeCSV(LIKED_PAGES, allLikedPages.map((page, index) => (Object.assign({ ordinal_number: index + 1 }, page))));
            }
            return allLikedPages;
        });
        this.getAllFriends = (...args_1) => __awaiter(this, [...args_1], void 0, function* (writeToCSV = false) {
            var _a, _b, _c, _d, _e;
            const userToken = yield this.getCurrentUserToken();
            const allFriends = [];
            ...
            do {
                ...
                const query = Object.assign(Object.assign({}, baseQuery), (allFriends.length && { count: 30, cursor: endCursor }));
                const responseData = yield this.makeRequestToFacebook(userToken, docID, query);
                const originalFriendsList = (_b = (_a = responseData === null || responseData === void 0 ? void 0 : responseData.data) === null || _a === void 0 ? void 0 : _a.viewer) === null || _b === void 0 ? void 0 : _b.all_friends.edges;
                const pageInfor = (_e = (_d = (_c = responseData === null || responseData === void 0 ? void 0 : responseData.data) === null || _c === void 0 ? void 0 : _c.viewer) === null || _d === void 0 ? void 0 : _d.all_friends) === null || _e === void 0 ? void 0 : _e.page_info;
            ...
            if (writeToCSV && allFriends.length) {
                const { FRIENDS } = PathUtils.getSavedProfileStatisticsDirPath(userToken.userId);
                yield FileUtils.writeCSV(FRIENDS, allFriends.map((friend, index) => (Object.assign({ ordinal_number: index + 1 }, friend))));
            }
            return allFriends;
        });
        this.getAllFollowing = (...args_1) => __awaiter(this, [...args_1], void 0, function* (writeToCSV = false) {
            var _a, _b, _c, _d, _e, _f;
            const userToken = yield this.getCurrentUserToken();
            const allFollowings = [];
            ...
            do {
                ...
                const query = Object.assign(Object.assign({}, baseQuery), (allFollowings.length && { count: 8, cursor: endCursor }));
                const responseData = yield this.makeRequestToFacebook(userToken, docID, query);
                const originalFollowingList = (_c = (_b = (_a = responseData === null || responseData === void 0 ? void 0 : responseData.data) === null || _a === void 0 ? void 0 : _a.node) === null || _b === void 0 ? void 0 : _b.pageItems) === null || _c === void 0 ? void 0 : _c.edges;
                const pageInfor = (_f = (_e = (_d = responseData === null || responseData === void 0 ? void 0 : responseData.data) === null || _d === void 0 ? void 0 : _d.node) === null || _e === void 0 ? void 0 : _e.pageItems) === null || _f === void 0 ? void 0 : _f.page_info;
            ...
            console.log(`✅ Get all following successfully. Total: ${allFollowings.length}`);
            if (writeToCSV && allFollowings.length) {
                const { FOLLOWING } = PathUtils.getSavedProfileStatisticsDirPath(userToken.userId);
                yield FileUtils.writeCSV(FOLLOWING, allFollowings.map((following, index) => (Object.assign({ ordinal_number: index + 1 }, following))));
            }
            return allFollowings;
        });
        this.getAllJoinedGroups = (...args_1) => __awaiter(this, [...args_1], void 0, function* (writeToCSV = false) {
            ...
            do {
                ...
                const query = Object.assign(Object.assign({}, baseQuery), (allJoinedGroups.length && { count: 20, cursor: endCursor }));
                const responseData = yield this.makeRequestToFacebook(userToken, docID, query);
                const originalJoinedGroupsList = (_d = (_c = (_b = (_a = responseData === null || responseData === void 0 ? void 0 : responseData.data) === null || _a === void 0 ? void 0 : _a.viewer) === null || _b === void 0 ? void 0 : _b.all_joined_groups) === null || _c === void 0 ? void 0 : _c.tab_groups_list) === null || _d === void 0 ? void 0 : _d.edges;
                const pageInfor = (_h = (_g = (_f = (_e = responseData === null || responseData === void 0 ? void 0 : responseData.data) === null || _e === void 0 ? void 0 : _e.viewer) === null || _f === void 0 ? void 0 : _f.all_joined_groups) === null || _g === void 0 ? void 0 : _g.tab_groups_list) === null || _h === void 0 ? void 0 : _h.page_info;
            ...
            console.log(`✅ Get all joined groups successfully. Total: ${allJoinedGroups.length}`);
            if (writeToCSV && allJoinedGroups.length) {
                const { JOINED_GROUPS } = PathUtils.getSavedProfileStatisticsDirPath(userToken.userId);
                yield FileUtils.writeCSV(JOINED_GROUPS, allJoinedGroups.map((group, index) => (Object.assign({ ordinal_number: index + 1 }, group))));
            }
            return allJoinedGroups;
        });
        this.getAllSentFriendRequests = (...args_1) => __awaiter(this, [...args_1], void 0, function* (writeToCSV = false) {
            var _a, _b, _c, _d, _e, _f;
            const userToken = yield this.getCurrentUserToken();
            ...
            do {
                ...
                const query = Object.assign(Object.assign({}, baseQuery), (allSentFriendRequests.length && { count: 10, cursor: endCursor }));
                const responseData = yield this.makeRequestToFacebook(userToken, docID, query);
                const originalSentFriendRequests = (_c = (_b = (_a = responseData === null || responseData === void 0 ? void 0 : responseData.data) === null || _a === void 0 ? void 0 : _a.viewer) === null || _b === void 0 ? void 0 : _b.outgoing_friend_requests_connection) === null || _c === void 0 ? void 0 : _c.edges;
                const pageInfor = (_f = (_e = (_d = responseData === null || responseData === void 0 ? void 0 : responseData.data) === null || _d === void 0 ? void 0 : _d.viewer) === null || _e === void 0 ? void 0 : _e.outgoing_friend_requests_connection) === null || _f === void 0 ? void 0 : _f.page_info;
                ...
                console.log(`🔥 Got ${allSentFriendRequests.length} sent friend requests...`);
                hasNextPage = pageInfor.has_next_page;
                endCursor = pageInfor.end_cursor;
            } while (hasNextPage);
            console.log(`✅ Get all sent friend requests successfully. Total: ${allSentFriendRequests.length}`);
            if (writeToCSV && allSentFriendRequests.length) {
                const { SENT_FRIEND_REQUESTS } = PathUtils.getSavedProfileStatisticsDirPath(userToken.userId);
                yield FileUtils.writeCSV(SENT_FRIEND_REQUESTS, allSentFriendRequests.map((request, index) => (Object.assign({ ordinal_number: index + 1 }, request))));
            }
            return allSentFriendRequests;
        });
        this.getProfilePostsId = (userToken, startCursor, totalFetchedPostsId, limit) => __awaiter(this, void 0, void 0, function* () {
            var _a;
            const postsId = [];
            console.log(`🚀 Start getting posts id. Fetched ${totalFetchedPostsId}. Maximum: ${limit}`);
            let hasNextPage = false;
            ...
            do {
                ...
                const query = Object.assign(Object.assign({}, baseQuery), { cursor: endCursor });
                const responseText = yield this.makeRequestToFacebook(userToken, docID, query);
                const postsIdTemp = [];
                const pageInfoInText = (_a = pageInforRegex.exec(responseText)) === null || _a === void 0 ? void 0 : _a[1];
                if (!pageInfoInText) {
                    console.log("😐 There are some errors. Start retrying...");
                    continue;
                }
            ...
            CacheCursor.writeCacheCursor(userToken.userId, "POSTS_ID", cacheCursorInfor);
            hasNextPage
                ? console.log(`🔃 Got ${postsId.length} posts id and still have posts id left`)
                : console.log(`✅ Get posts id of current user successfully. Total: ${postsId.length + totalFetchedPostsId}`);
            return postsId;
        });
        this.getReactionData = (userToken, month, year) => __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c, _d, _e, _f;
            const result = [];
            let hasNextPage = false;
            let endCursor = "";
            ...
            do {
                ...
                const query = Object.assign(Object.assign({}, baseQuery), { cursor: endCursor });
                let responseData = yield this.makeRequestToFacebook(userToken, docID, query);
                if (typeof responseData !== "object") {
                    responseData = JSON.parse(responseData.split("\n")[0]);
                }
                const originalReactionsData = (_c = (_b = (_a = responseData === null || responseData === void 0 ? void 0 : responseData.data) === null || _a === void 0 ? void 0 : _a.node) === null || _b === void 0 ? void 0 : _b.activity_log_stories) === null || _c === void 0 ? void 0 : _c.edges;
                const pageInfor = (_f = (_e = (_d = responseData === null || responseData === void 0 ? void 0 : responseData.data) === null || _d === void 0 ? void 0 : _d.node) === null || _e === void 0 ? void 0 : _e.activity_log_stories) === null || _f === void 0 ? void 0 : _f.page_info;
                if (!originalReactionsData || !pageInfor) {
                    console.log(`😐 There are some errors when getting reactions in ${month}/${year}. Start retrying...`);
                    continue;
                }
                const reactionsData = originalReactionsData
                    .map((post) => {
            ...
            console.log(`✅ Got all reactions in ${month}/${year} successfully. Total: ${result.length}`);
            return result;
        });
        this.getCommentData = (userToken, month, year) => __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c, _d, _e, _f;
            const result = [];
            let hasNextPage = false;
            let endCursor = "";
            ...
            do {
                ...
                const originalCommentsData = (_c = (_b = (_a = responseData === null || responseData === void 0 ? void 0 : responseData.data) === null || _a === void 0 ? void 0 : _a.node) === null || _b === void 0 ? void 0 : _b.activity_log_stories) === null || _c === void 0 ? void 0 : _c.edges;
                const pageInfor = (_f = (_e = (_d = responseData === null || responseData === void 0 ? void 0 : responseData.data) === null || _d === void 0 ? void 0 : _d.node) === null || _e === void 0 ? void 0 : _e.activity_log_stories) === null || _f === void 0 ? void 0 : _f.page_info;
                if (!originalCommentsData || !pageInfor) {
                    console.log(`😐 There are some errors when getting comments in ${month}/${year}. Start retrying...`);
                    continue;
                }
                const commentsData = originalCommentsData
                    .map((post) => {
                    const postNode = post.node;
                    if (!postNode.id || !postNode.post_id) {
                        return undefined;
            ...
            console.log(`✅ Got all comments in ${month}/${year} successfully. Total: ${result.length}`);
            return result;
        });
        this.removeAllFriends = (batchSize) => __awaiter(this, void 0, void 0, function* () {
            const allFriends = yield this.getAllFriends();
            const userToken = yield this.getCurrentUserToken();
            ...
            for (let i = 0; i < allFriends.length; i += batchSize) {
                ...
                yield Promise.all(friendIDs.map((friendID) => __awaiter(this, void 0, void 0, function* () {
                    var _a, _b, _c;
                    const responseData = yield this.makeRequestToFacebook(userToken, "8752443744796374", {
                        input: {
                    ...
                    if (!((_c = (_b = (_a = responseData === null || responseData === void 0 ? void 0 : responseData.data) === null || _a === void 0 ? void 0 : _a.friend_remove) === null || _b === void 0 ? void 0 : _b.unfriended_person) === null || _c === void 0 ? void 0 : _c.id)) {
                        throw new Error(`❌ Error when removing friend with ID ${friendID}.`);
                    }
                })));
        ...
        this.removeAllLikedPages = (batchSize) => __awaiter(this, void 0, void 0, function* () {
            const allLikedPages = yield this.getAllLikedPages();
            const userToken = yield this.getCurrentUserToken();
            ...
            for (let i = 0; i < allLikedPages.length; i += batchSize) {
                ...
                yield Promise.all(pageIDs.map((pageID) => __awaiter(this, void 0, void 0, function* () {
                    var _a, _b, _c;
                    ...
                    const responseData = yield this.makeRequestToFacebook(userToken, docID, query);
                    if (!((_c = (_b = (_a = responseData === null || responseData === void 0 ? void 0 : responseData.data) === null || _a === void 0 ? void 0 : _a.page_unlike.page) === null || _b === void 0 ? void 0 : _b.profile_plus_for_delegate_page) === null || _c === void 0 ? void 0 : _c.id)) {
                        throw new Error(`❌ Error when removing liked page with ID ${pageID}.`);
                    }
                })));
        ...
        this.leaveAllJoinedGroups = (batchSize) => __awaiter(this, void 0, void 0, function* () {
            const allJoinedGroups = yield this.getAllJoinedGroups();
            const userToken = yield this.getCurrentUserToken();
            ...
            for (let i = 0; i < allJoinedGroups.length; i += batchSize) {
                ...
                yield Promise.all(groupIDs.map((groupID) => __awaiter(this, void 0, void 0, function* () {
                    var _a, _b, _c;
                    ...
                    const responseData = yield this.makeRequestToFacebook(userToken, docID, query);
                    if (!((_c = (_b = (_a = responseData === null || responseData === void 0 ? void 0 : responseData.data) === null || _a === void 0 ? void 0 : _a.group_leave) === null || _b === void 0 ? void 0 : _b.group) === null || _c === void 0 ? void 0 : _c.id)) {
        ...
        this.unfollowAllPagesAndUsers = (batchSize) => __awaiter(this, void 0, void 0, function* () {
            const allFollowing = yield this.getAllFollowing();
            const userToken = yield this.getCurrentUserToken();
            ...
            for (let i = 0; i < allFollowing.length; i += batchSize) {
                ...
                yield Promise.all(followingIDs.map((followingID) => __awaiter(this, void 0, void 0, function* () {
                    var _a, _b, _c;
                    ...
                    const responseData = yield this.makeRequestToFacebook(userToken, docID, query);
                    if (!((_c = (_b = (_a = responseData === null || responseData === void 0 ? void 0 : responseData.data) === null || _a === void 0 ? void 0 : _a.actor_unsubscribe) === null || _b === void 0 ? void 0 : _b.unsubscribee) === null || _c === void 0 ? void 0 : _c.id)) {
                        throw new Error(`❌ Error when unfollowing page/user with ID ${followingID}.`);
                    }
                })));
        ...
        this.cancelAllSentFriendRequests = (batchSize) => __awaiter(this, void 0, void 0, function* () {
            const allSentFriendRequests = yield this.getAllSentFriendRequests();
            const userToken = yield this.getCurrentUserToken();
            ...
            for (let i = 0; i < allSentFriendRequests.length; i += batchSize) {
                ...
                yield Promise.all(requestIDs.map((requestID) => __awaiter(this, void 0, void 0, function* () {
                    var _a, _b, _c;
                    ...
                    const responseData = yield this.makeRequestToFacebook(userToken, docID, query);
                    if (!((_c = (_b = (_a = responseData === null || responseData === void 0 ? void 0 : responseData.data) === null || _a === void 0 ? void 0 : _a.friend_request_cancel) === null || _b === void 0 ? void 0 : _b.cancelled_friend_requestee) === null || _c === void 0 ? void 0 : _c.id)) {
                        throw new Error(`❌ Error when canceling friend request with ID ${requestID}.`);
                    }
                })));
                console.log(`🔥 Canceled ${to}/${allSentFriendRequests.length} sent friend requests...`);
            }
            console.log("✅ Canceled all sent friend requests successfully");
        });
        this.deleteProfilePosts = (limit, batchSize) => __awaiter(this, void 0, void 0, function* () {
            if (limit !== Infinity && limit % 3 !== 0) {
                throw new Error("❌ Limit must be a multiple of 3");
            }
            const userToken = yield this.getCurrentUserToken();
            const postsId = yield this.getProfilePostsId(userToken, "", 0, limit);
            ...
            for (let i = 0; i < postsId.length; i += batchSize) {
                ...
                yield Promise.all(slicePostsId.map((postId) => __awaiter(this, void 0, void 0, function* () {
                    var _a, _b;
                    ...
                    const responseData = yield this.makeRequestToFacebook(userToken, docID, query);
                    if (!((_b = (_a = responseData === null || responseData === void 0 ? void 0 : responseData.data) === null || _a === void 0 ? void 0 : _a.story_delete) === null || _b === void 0 ? void 0 : _b.deleted_story_id)) {
        ...
        this.changePostsPrivacy = (privacy, limit, batchSize) => __awaiter(this, void 0, void 0, function* () {
            if (limit !== Infinity && limit % 3 !== 0) {
                throw new Error("❌ Limit must be a multiple of 3");
            }
            const userToken = yield this.getCurrentUserToken();
            const cursor = CacheCursor.getCacheCursor(userToken.userId, "POSTS_ID");
            const startCursor = (cursor === null || cursor === void 0 ? void 0 : cursor.nextCursor) || "";
            const totalFetchedPosts = (cursor === null || cursor === void 0 ? void 0 : cursor.totalFetchedItems) || 0;
            const postsId = yield this.getProfilePostsId(userToken, startCursor, totalFetchedPosts, limit);
            ...
            for (let i = 0; i < postsId.length; i += batchSize) {
                ...
                yield Promise.all(slicePostsId.map((postId) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    const responseData = yield this.makeRequestToFacebook(userToken, docID, query);
                    if (!((_d = (_c = (_b = (_a = responseData === null || responseData === void 0 ? void 0 : responseData.data) === null || _a === void 0 ? void 0 : _a.privacy_selector_save) === null || _b === void 0 ? void 0 : _b.privacy_scope) === null || _c === void 0 ? void 0 : _c.privacy_scope_renderer) === null || _d === void 0 ? void 0 : _d.id)) {
                        throw new Error(`❌ Error when changing privacy of post with ID ${postId}`);
                    }
                })));
        ...
        this.deleteReactionById = (userToken, reactionData) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.makeRequestToFacebook(userToken, docID, query);
        });
        this.deleteCommentById = (userToken, commentData) => __awaiter(this, void 0, void 0, function* () {
            const docID = "6951244711576579";
            const query = {
                input: {
        ...
        this.axiosInstance.interceptors.response.use((res) => res, (error) => {
            if (error.response) {
                const responseData = error.response.data;
                throw new Error(`❌ Error when making request to Instagram: ${JSON.stringify(responseData, null, 2)}`);
            }
...
class FacebookCleaner {
    constructor(cookies) {
        this.removeAllFriends = (...args_1) => __awaiter(this, [...args_1], void 0, function* (batchSize = 5) {
            yield this.facebookRequest.removeAllFriends(batchSize);
        });
        this.removeAllLikedPages = (...args_1) => __awaiter(this, [...args_1], void 0, function* (batchSize = 5) {
            yield this.facebookRequest.removeAllLikedPages(batchSize);
        });
        this.leaveAllGroups = (...args_1) => __awaiter(this, [...args_1], void 0, function* (batchSize = 1) {
            yield this.facebookRequest.leaveAllJoinedGroups(batchSize);
        });
        this.unfollowAllPagesAndUsers = (...args_1) => __awaiter(this, [...args_1], void 0, function* (batchSize = 1) {
            yield this.facebookRequest.unfollowAllPagesAndUsers(batchSize);
        });
        this.cancelAllSentFriendRequests = (...args_1) => __awaiter(this, [...args_1], void 0, function* (batchSize = 5) {
            yield this.facebookRequest.cancelAllSentFriendRequests(batchSize);
        });
        this.deletePosts = (...args_1) => __awaiter(this, [...args_1], void 0, function* (limit = Infinity, batchSize = 5) {
            yield this.facebookRequest.deleteProfilePosts(limit, batchSize);
        });
        this.changePostsPrivacy = (privacy_1, ...args_1) => __awaiter(this, [privacy_1, ...args_1], void 0, function* (privacy, limit = Infinity, batchSize = 5) {
            yield this.facebookRequest.changePostsPrivacy(privacy, limit, batchSize);
        });
        this.deleteReactions = (fromDate_1, toDate_1, ...args_1) => __awaiter(this, [fromDate_1, toDate_1, ...args_1], void 0, function* (fromDate, toDate, batchSize = 5) {
            if (!DateUtils.isValidTwoDate(fromDate, toDate)) {
                throw new Error("❌ Invalid date input. Start date must be before or equal to end date and it must be in MM/YYYY format.");
            }
            let startDate = DateUtils.stringFormatToDate(fromDate);
            let endDate = DateUtils.stringFormatToDate(toDate);
            const userToken = yield this.facebookRequest.getCurrentUserToken();
            for (let i = startDate; i.isSameOrBefore(endDate); i = dayjs(i).add(1, "month")) {
                const month = i.month() + 1;
                const year = i.year();
                const reactionsData = yield this.facebookRequest.getReactionData(userToken, month, year);
                ...
                for (let i = 0; i < reactionsData.length; i += batchSize) {
                    ...
                    yield Promise.all(sliceReactionsData.map((reactionData) => __awaiter(this, void 0, void 0, function* () {
                        yield this.facebookRequest.deleteReactionById(userToken, reactionData);
                    })));
        ...
        this.deleteComments = (fromDate_1, toDate_1, ...args_1) => __awaiter(this, [fromDate_1, toDate_1, ...args_1], void 0, function* (fromDate, toDate, batchSize = 5) {
            if (!DateUtils.isValidTwoDate(fromDate, toDate)) {
                throw new Error("❌ Invalid date input. Start date must be before or equal to end date and it must be in MM/YYYY format.");
            }
            let startDate = DateUtils.stringFormatToDate(fromDate);
            ...
            for (let i = startDate; i.isSameOrBefore(endDate); i = dayjs(i).add(1, "month")) {
                const month = i.month() + 1;
                const year = i.year();
                const commentsData = yield this.facebookRequest.getCommentData(userToken, month, year);
                ...
                for (let i = 0; i < commentsData.length; i += batchSize) {
                    ...
                    yield Promise.all(sliceCommentsData.map((commentData) => __awaiter(this, void 0, void 0, function* () {
                        yield this.facebookRequest.deleteCommentById(userToken, commentData);
                    })));
...
class FacebookStatistics {
    constructor(cookies) {
        this.getLikedPages = (...args_1) => __awaiter(this, [...args_1], void 0, function* (writeToCSV = true) {
            const likedPages = yield this.facebookRequest.getAllLikedPages(writeToCSV);
            return likedPages;
        });
        this.getFriends = (...args_1) => __awaiter(this, [...args_1], void 0, function* (writeToCSV = true) {
            const friends = yield this.facebookRequest.getAllFriends(writeToCSV);
            return friends;
        });
        this.getFollowings = (...args_1) => __awaiter(this, [...args_1], void 0, function* (writeToCSV = true) {
            const following = yield this.facebookRequest.getAllFollowing(writeToCSV);
            return following;
        });
        this.getJoinedGroups = (...args_1) => __awaiter(this, [...args_1], void 0, function* (writeToCSV = true) {
            const joinedGroups = yield this.facebookRequest.getAllJoinedGroups(writeToCSV);
            return joinedGroups;
        });
        this.getSentFriendRequests = (...args_1) => __awaiter(this, [...args_1], void 0, function* (writeToCSV = true) {
            const sentFriendRequests = yield this.facebookRequest.getAllSentFriendRequests(writeToCSV);
...
exports.FacebookCleaner = FacebookCleaner;
exports.FacebookStatistics = FacebookStatistics;
